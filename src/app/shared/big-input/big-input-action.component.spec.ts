...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<afnms-big-input-action></afnms-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<afnms-big-input-action [disabled]="true"></afnms-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<afnms-big-input-action fontSet="fas" fontIcon="fa-trash"></afnms-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<afnms-big-input-action label="delete"></afnms-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<afnms-big-input-action (action)="actionHandler()"></afnms-big-input-action>`;
    fixture = createHostComponent(template);
